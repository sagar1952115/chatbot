...
const Sidebar = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed lg:static bg-gray-100 z-50 w-full top-0 left-0 h-screen border-r shadow-md overflow-hidden transition-all duration-300 ease-in-out ${
                ...
                chat.messages.length > 0 && (
                  <li
                    ...
                    className={`p-2  w-full hover:bg-gray-200 rounded-md cursor-pointer ${
                      chat.id == activeChatId ? "bg-gray-300" : "bg-transparent"
                    }`}
                  >
                    {getChatTitle(chat)}
                  </li>
